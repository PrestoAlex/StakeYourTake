(module
 ...
 (global $assembly/comment/CommentCounter/COMMENT_COUNT_POINTER (mut i32) (i32.const 0))
 ...
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $start:assembly/comment/index~anonymous|0)
 (export "abort" (func $assembly/comment/index/abort))
 ...
 (func $assembly/comment/index/abort (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  local.get $0
  local.get $1
  local.get $2
  local.get $3
 ...
 (func $start:assembly/comment/index~anonymous|0 (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  ...
  call $~lib/rt/__newArray
  i32.store
  global.get $assembly/comment/CommentCounter/COMMENT_COUNT_POINTER
  local.set $2
 ...
 (func $~start
  ...
  i32.const 65535
  i32.and
  global.set $assembly/comment/CommentCounter/COMMENT_COUNT_POINTER
  global.get $~lib/@btc-vision/btc-runtime/runtime/env/index/Blockchain
  local.tee $0
  i32.const 7808
  i32.store offset=28
